...
"color: rgb(41, 134, 255);")
        ...
        self.action = QtWidgets.QAction(Ui)
        self.action.setObjectName("action")
        self.action_3 = QtWidgets.QAction(Ui)
    ...
    def retranslateUi(self, Ui):
        ...
        self.action.setText(_translate("Ui", "Закрыть"))
        self.action_3.setText(_translate("Ui", "Лицензия"))
