...
class Ui_UiLeft(object):
    def setupUi(self, UiLeft):
        UiLeft.setObjectName("UiLeft")
        UiLeft.resize(755, 536)
        UiLeft.setMinimumSize(QtCore.QSize(755, 536))
        UiLeft.setMaximumSize(QtCore.QSize(1000, 536))
        font = QtGui.QFont()
        font.setKerning(True)
        UiLeft.setFont(font)
        UiLeft.setWindowOpacity(1.0)
        UiLeft.setStyleSheet("")
        self.centralwidget = QtWidgets.QWidget(UiLeft)
...
"color: rgb(41, 134, 255);")
        ...
        UiLeft.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(UiLeft)
        self.menubar.setGeometry(QtCore.QRect(500, 0, 755, 21))
        ...
        self.menu_2.setGeometry(QtCore.QRect(341, 136, 135, 94))
        self.menu_2.setObjectName("menu_2")
        UiLeft.setMenuBar(self.menubar)
        self.openSettings = QtWidgets.QAction(UiLeft)
        font = QtGui.QFont()
        self.openSettings.setFont(font)
        self.openSettings.setObjectName("openSettings")
        self.actionAbout = QtWidgets.QAction(UiLeft)
        self.actionAbout.setObjectName("actionAbout")
        self.action0 = QtWidgets.QAction(UiLeft)
        self.action0.setObjectName("action0")
        self.actionClose = QtWidgets.QAction(UiLeft)
        self.actionClose.setObjectName("actionClose")
        self.actionLicense = QtWidgets.QAction(UiLeft)
        self.actionLicense.setObjectName("actionLicense")
        self.actionValidator = QtWidgets.QAction(UiLeft)
        self.actionValidator.setObjectName("actionValidator")
        self.actionAbout_2 = QtWidgets.QAction(UiLeft)
        self.actionAbout_2.setObjectName("actionAbout_2")
        self.actionLicense_2 = QtWidgets.QAction(UiLeft)
        ...
        self.retranslateUi(UiLeft)
        QtCore.QMetaObject.connectSlotsByName(UiLeft)

    def retranslateUi(self, UiLeft):
        _translate = QtCore.QCoreApplication.translate
        UiLeft.setWindowTitle(_translate("UiLeft", "Tend Менеджер"))
        self.label_6.setText(_translate("UiLeft", "Документация"))
        self._btnView.setText(_translate("UiLeft", "Обзор..."))
        self.label.setText(_translate("UiLeft", "Наименование заказчика"))
        self.label_5.setText(_translate("UiLeft", "Федеральный закон"))
        self._radio44.setText(_translate("UiLeft", "№ 44"))
        self._radio223.setText(_translate("UiLeft", "№ 223"))
        self.label_2.setText(_translate("UiLeft", "Реестровый номер закупки"))
        self.label_15.setText(_translate("UiLeft", "Категория"))
        self.label_3.setText(_translate("UiLeft", "Способ закупки"))
        self.label_4.setText(_translate("UiLeft", "Предмет закупки"))
        self._checkBoxPayment.setText(_translate("UiLeft", "Создать расчет"))
        self.label_appSecurity.setText(_translate("UiLeft", "Обеспечение заявки"))
        self.label_contractSecurity.setText(_translate("UiLeft", "Обеспечение контракта"))
        self.label_currentPrice.setText(_translate("UiLeft", "Начальная цена"))
        self.label_place.setText(_translate("UiLeft", "Место поставки"))
        self.label_period.setText(_translate("UiLeft", "Срок поставки"))
        self.label_positionCount.setText(_translate("UiLeft", "Количество позиций"))
        self._btnGenerate.setText(_translate("UiLeft", "Создать"))
        self.menu.setTitle(_translate("UiLeft", "     Опции"))
        self.chose_lasts.setTitle(_translate("UiLeft", "Последние"))
        self.menu_2.setTitle(_translate("UiLeft", "Справка"))
        self.openSettings.setText(_translate("UiLeft", "Настройки"))
        self.actionAbout.setText(_translate("UiLeft", "О программе"))
        self.action0.setText(_translate("UiLeft", "0"))
        self.actionClose.setText(_translate("UiLeft", "Выход"))
        self.actionLicense.setText(_translate("UiLeft", "Лицензия"))
        self.actionValidator.setText(_translate("UiLeft", "Валидатор"))
        self.actionAbout_2.setText(_translate("UiLeft", "О программе"))
        self.actionLicense_2.setText(_translate("UiLeft", "Лицензия"))
