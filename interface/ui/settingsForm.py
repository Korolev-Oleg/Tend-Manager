...
class Ui_settings(object):
    def setupUi(self, settings):
        ...
        self.word_chbx_default = QtWidgets.QCheckBox(self.tab_4)
        self.word_chbx_default.setObjectName("word_chbx_default")
        self.gridLayout_3.addWidget(self.word_chbx_default, 0, 1, 1, 1)
        self.word_combo_default = QtWidgets.QComboBox(self.tab_4)
        self.word_combo_default.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.word_combo_default.sizePolicy().hasHeightForWidth())
        self.word_combo_default.setSizePolicy(sizePolicy)
        self.word_combo_default.setObjectName("word_combo_default")
        self.gridLayout_3.addWidget(self.word_combo_default, 1, 1, 1, 1)
        ...
        self.excel_radio_cell = QtWidgets.QRadioButton(self.tab_5)
        self.excel_radio_cell.setObjectName("excel_radio_cell")
        self.horizontalLayout_15.addWidget(self.excel_radio_cell)
        self.excel_radio_var = QtWidgets.QRadioButton(self.tab_5)
        self.excel_radio_var.setObjectName("excel_radio_var")
        self.horizontalLayout_15.addWidget(self.excel_radio_var)
        ...
        self.excel_chbx_default = QtWidgets.QCheckBox(self.tab_5)
        self.excel_chbx_default.setObjectName("excel_chbx_default")
        self.horizontalLayout_22.addWidget(self.excel_chbx_default)
        ...
        self.horizontalLayout_23.addWidget(self.excel_editline)
        self.excel_combo_default = QtWidgets.QComboBox(self.tab_5)
        self.excel_combo_default.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.excel_combo_default.sizePolicy().hasHeightForWidth())
        self.excel_combo_default.setSizePolicy(sizePolicy)
        self.excel_combo_default.setObjectName("excel_combo_default")
        self.horizontalLayout_23.addWidget(self.excel_combo_default)
        ...
        self.excel_combo_sheet = QtWidgets.QComboBox(self.tab_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.excel_combo_sheet.sizePolicy().hasHeightForWidth())
        self.excel_combo_sheet.setSizePolicy(sizePolicy)
        self.excel_combo_sheet.setEditable(True)
        self.excel_combo_sheet.setObjectName("excel_combo_sheet")
        self.excel_combo_sheet.addItem("")
        self.excel_combo_sheet.addItem("")
        self.excel_combo_sheet.addItem("")
        self.horizontalLayout_8.addWidget(self.excel_combo_sheet)
        ...
        self.projectspath = QtWidgets.QLineEdit(self.tab_3)
        ...
        self.btnProjectpath = QtWidgets.QToolButton(self.tab_3)
        ...
        self.paymentpath = QtWidgets.QLineEdit(self.tab_3)
        ...
        self.btnPaymentpath = QtWidgets.QToolButton(self.tab_3)
        ...
        self.saveDataGeneral = QtWidgets.QPushButton(self.tab_3)
        self.saveDataGeneral.setObjectName("saveDataGeneral")
        self.horizontalLayout_7.addWidget(self.saveDataGeneral)
        self.verticalLayout_2.addLayout(self.horizontalLayout_7)
        self.label_18 = QtWidgets.QLabel(self.tab_3)
        self.label_18.setObjectName("label_18")
        self.verticalLayout_2.addWidget(self.label_18)
        self.treeProjectStruct = QtWidgets.QTreeWidget(self.tab_3)
        ...
        item_1 = QtWidgets.QTreeWidgetItem(item_0)
        item_0 = QtWidgets.QTreeWidgetItem(self.treeProjectStruct)
        self.verticalLayout_2.addWidget(self.treeProjectStruct)
    ...
    def retranslateUi(self, settings):
        ...
        self.tabWidget_2.setToolTip(_translate("settings", "<html><head/><body><p><span style=\" font-weight:600;\">Стандартное значение</span> представляет собой динамически изменяемые поля, такие как Начальная максимальная цена. Текущая дата прописью, цифрами и т.д.</p></body></html>"))
        self.word_editline.setToolTip(_translate("settings", "<html><head/><body><p><span style=\" font-weight:600;\">Имя переменной.</span> Программа будет искать данное значение во всех приложенных документах</p><p><span style=\" font-weight:600; color:#141c68;\">Пример: </span><span style=\" font-weight:600; color:#ff530f;\">%ФИО%</span></p></body></html>"))
        self.label_7.setText(_translate("settings", "Переменная"))
        self.word_chbx_default.setText(_translate("settings", "Стандартное значение"))
        self.word_combo_default.setToolTip(_translate("settings", "<html><head/><body><p><span style=\" font-weight:600;\">Стандартное значение</span> представляет собой динамически изменяемые поля, такие как Начальная максимальная цена. Текущая дата прописью, цифрами и т.д.</p></body></html>"))
        self.label_9.setText(_translate("settings", "Текст"))
        self.word_value.setToolTip(_translate("settings", "<html><head/><body><p>Вы можете указать свое статическое значение переменной, на которое будет произведена замена в документах.</p></body></html>"))
        ...
        self.word_tree.headerItem().setText(1, _translate("settings", "Текст"))
        self.word_tree.headerItem().setText(2, _translate("settings", "Стандартное значение"))
        ...
        self.excel_radio_cell.setToolTip(_translate("settings", "<html><head/><body><p/></body></html>"))
        self.excel_radio_cell.setText(_translate("settings", "Ячейка"))
        self.excel_radio_var.setToolTip(_translate("settings", "<html><head/><body><p/></body></html>"))
        self.excel_radio_var.setText(_translate("settings", "Переменная"))
        self.excel_chbx_default.setText(_translate("settings", "Стандартное значение"))
...
"<head/>\n"
"    <body>\n"
"        <p>Данный текст вставляется на место найденной в документе переменной или ячейки</p>\n"
"    </body>\n"
"</html>"))
        ...
        self.excel_tree.headerItem().setText(1, _translate("settings", "Ячейка"))
        self.excel_tree.headerItem().setText(2, _translate("settings", "Лист"))
        self.excel_tree.headerItem().setText(3, _translate("settings", "Значение / текст"))
        ...
        self.default_tree.setToolTip(_translate("settings", "<html><head/><body><p><span style=\" font-weight:600;\">Стандартное значение</span> представляет собой динамически изменяемые поля, такие как Начальная максимальная цена. Текущая дата прописью, цифрами и т.д. </p><p>Вставте нужную переменную обозначенную процентами с обеих сторон <span style=\" color:#ff5500;\">%</span><span style=\" color:#07b607;\">ПЕРЕМЕННАЯ</span><span style=\" color:#ff5500;\">%</span> в ваш документ </p></body></html>"))
        ...
        self.default_tree.headerItem().setText(2, _translate("settings", "Значение"))
        ...
        self.default_tree.topLevelItem(0).setText(2, _translate("settings", "12.03.2019"))
        self.default_tree.setSortingEnabled(__sortingEnabled)
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_8), _translate("settings", "Стандартные значения"))
        ...
        self.label_16.setText(_translate("settings", "Файл расчета xlsx"))
        ...
        self.saveDataGeneral.setText(_translate("settings", "сохранить"))
        self.label_18.setText(_translate("settings", "Структура проекта"))
