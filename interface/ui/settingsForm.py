...
class Ui_settings(object):
    def setupUi(self, settings):
        ...
        self.pushAllButton.setIcon(icon)
        self.pushAllButton.setObjectName("pushAllButton")
        self.horizontalLayout_2.addWidget(self.pushAllButton)
        ...
        self.btn_pushTotree.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("interface/icons/remove.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_removeFromtree.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("interface/icons/clear.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.word_btn_add.setIcon(icon1)
        ...
        self.word_btn_del.setIcon(icon2)
        ...
        self.horizontalLayout_7.addWidget(self.sharedCheckBox)
        self.onTopCheckBox = QtWidgets.QCheckBox(self.groupBox_5)
        self.onTopCheckBox.setObjectName("onTopCheckBox")
        self.horizontalLayout_7.addWidget(self.onTopCheckBox)
        ...
        self.gridLayout_2.addWidget(self.SharedButton, 5, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.sharedPathLine, 5, 0, 1, 1)
        ...
        self.wnd_free_move = QtWidgets.QCheckBox(self.groupBox_6)
        self.wnd_free_move.setObjectName("wnd_free_move")
        self.gridLayout_4.addWidget(self.wnd_free_move, 1, 0, 1, 1)
        self.wnd_fix_right = QtWidgets.QRadioButton(self.groupBox_6)
        self.wnd_fix_right.setChecked(True)
        self.wnd_fix_right.setObjectName("wnd_fix_right")
        self.gridLayout_4.addWidget(self.wnd_fix_right, 2, 1, 1, 1)
        self.wnd_fix_left = QtWidgets.QRadioButton(self.groupBox_6)
        self.wnd_fix_left.setObjectName("wnd_fix_left")
        self.gridLayout_4.addWidget(self.wnd_fix_left, 2, 0, 1, 1)
        self.wnd_on_top = QtWidgets.QCheckBox(self.groupBox_6)
        self.wnd_on_top.setObjectName("wnd_on_top")
        self.gridLayout_4.addWidget(self.wnd_on_top, 1, 1, 1, 1)
    ...
    def retranslateUi(self, settings):
        ...
        self.pushAllButton.setText(_translate("settings", "Общие"))
        ...
        self.groupBox_5.setTitle(_translate("settings", "Прочие"))
        self.sharedCheckBox.setText(_translate("settings", "Общий доступ к настройкам"))
        self.onTopCheckBox.setText(_translate("settings", "Поверх всех окон"))
        ...
        self.groupBox_6.setTitle(_translate("settings", "Окно"))
        self.wnd_free_move.setText(_translate("settings", "Свободное перемещение"))
        self.wnd_fix_right.setText(_translate("settings", "Закрепить справа"))
        self.wnd_fix_left.setText(_translate("settings", "Закрепить слева"))
        self.wnd_on_top.setText(_translate("settings", "Поверх всех окон"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_6), _translate("settings", "Прочие"))
